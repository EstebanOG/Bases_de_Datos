...
/*  Created On : 18-feb.-2020 01:11:58 p.m. 				*/
/*  DBMS       : PostgreSQL 						*/
/* ---------------------------------------------------- */
...
ALTER TABLE "Convicto" ADD CONSTRAINT "CK_sexo" CHECK (sexo IN ('f, m, F'))
;

ALTER TABLE "Convicto" ADD CONSTRAINT "CK_cedula" CHECK (cedula > 0)
;
...
ALTER TABLE "Pena" ADD CONSTRAINT "CK_fecha_ingreso" CHECK (fecha_ingreso < fecha_salida)
;
